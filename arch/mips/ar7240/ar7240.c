...
#else
unsigned int ar7240_slic_status_rd(void) { return ar7240_reg_rd(AR7240_SLIC_SLOT_SUPPORT); }
void ar7240_slic_freq_div_wr(unsigned int val)    { ar7240_reg_wr( AR7240_SLIC_FREQ_DIV,  val); }
unsigned int ar7240_slic_cntrl_rd(void)  { return ar7240_reg_rd(AR7240_SLIC_CNTL); }
void ar7240_slic_cntrl_wr(unsigned int val)       { ar7240_reg_wr(AR7240_SLIC_CNTL, val);    }
